...
//    }
//
//    public function addRuleField($fieldName, $fieldRule){
//
//
//        switch ($fieldRule[0]) {
//            case 'min_length':
//                if (strlen($_POST[$fieldName]) < $fieldRule[1])
//                    $this->addRuleMessage($fieldName, 'bu sahe deyeri ' . $fieldRule[1] . '-den kicik ola bilmez');
//                    break;
//            case 'empty':
//                if (empty($_POST[$fieldName]))
//                    $this->addRuleMessage($fieldName, 'bu sahe bosh ola bilmez');
//                break;
//        }
//
//    }
...
//    }
//
//    private function addRuleMessage($fieldname, $message){
//        $this->formValid = false;
//
//        return $this->field_errors[$fieldname] = $message;
//
//
//    }
//
//    public function printErrors($fieldName){
//
//       return $this->field_errors[$fieldName];
//
//    }
